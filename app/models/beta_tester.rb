class BetaTester < ApplicationRecord
  ...
  SOCIAL_NETWORKS = %w[ Snapchat Facebook Telegram Whatsapp Twitter Instagram ]
  validates :favorite_social_network, presence: true, inclusion: { in: SOCIAL_NETWORKS, message: "Veuillez sélectionner un réseau social valide" }
