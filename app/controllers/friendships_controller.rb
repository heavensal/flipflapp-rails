class FriendshipsController < ApplicationController
  ...
  def destroy
    ...
    if friendship.receiver == current_user && friendship.status == "pending"
      friendship.destroy
      redirect_back fallback_location: friendships_path, alert: "Demande d'amitié refusée."
    ...
    # 2ème cas : current_user est sender ou receiver et l'amitié est acceptée (suppression d'ami)
      ...
      friendship.destroy
      redirect_back fallback_location: friendships_path, alert: "Vous n'êtes plus ami avec #{other_user.first_name}."
    ...
    # 3ème cas : current_user est le sender et annule sa demande (pending)
      ...
      friendship.destroy
      redirect_back fallback_location: friendships_path, alert: "Demande d'amitié annulée."

    else
      redirect_back fallback_location: friendships_path, alert: "Action non autorisée."
    end
  end
end
